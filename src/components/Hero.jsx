  ...
  return (
    ...
    '> 
        <div className='flex flex-col gap-4'>
            ...
            sm:text-5xl md:text-6xl lgtext-7xl'>
                Vuyo
        ...
        <p className='text-sm md:text-base font-light'>
            ...
            </span> and accept all risks of becoming the local <span className='text-blue-400 font-medium'>
        ...
        <button className='px-8 py-4 rounded-md border-[2px]
         bg-slate-950 border-blue-400 border-blue-400 border-solid blueShadow  '>
            <p>Accept & Begin</p>
        </button>
